...
//   return res.status(400).send({status: false, message: 'provide correct formate of address'})
//  }
...
// }
    ...
    //          login verification  
        ...
        const user = await userModel.findOne({email, password})     //doubt over this deletion flag
